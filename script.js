...
opening.to('#preloader-black', {yPercent: -110, ease: Expo.easeInOut, duration: 1.7})
        ...
        .to('.ryrd.stay2', { transform: 'translateX(120%)', scale: 1.5, ease: Expo.easeInOut, duration: .5 }, '-=.5')
        ...
        .to('.ryrd.stay3', { transform: 'translateX(430%)', scale: 1.5, ease: Expo.easeInOut, duration: .5 }, '-=.46')
