...
ScrollTrigger.matchMedia({
        "(max-width: 450px)": () => {
                opening.to('#preloader-black', {yPercent: -110, ease: Expo.easeInOut, duration: 1.7})
                        ...
                        .to('.stay4-1', { transform: 'rotateY(-90deg)' , ease: Expo.easeIn, duration: .5 },'-=.1')
                        .to('.stay4-2', { transform: 'rotateY(-90deg)' , ease: Expo.easeIn, duration: .5 }, '<')        
                        .to('.ryrd.gone', { opacity: 0, stagger: .06, ease: Expo.easeIn, duration: .1 }, '-=.3')
                        .set('#header-title1', { overflowY: 'visible' }, '<')
                        .to('.stay4', { margin: '0%' }, '<')
                        .to('.ryrd.stay2', { transform: 'translateX(150%)', scale: 1.75, ease: Expo.easeInOut, duration: .5 }, '-=.65')
                        .to('.ryrd.stay1', { transform: 'translateX(180%)', scale: 1.75, ease: Expo.easeInOut, duration: .5 }, '-=.61')
                        .to('.ryrd.stay4', { transform: 'translateX(462%)', scale: 1.75, ease: Expo.easeInOut, duration: .5 }, '-=.63')
                        .to('.ryrd.stay3', { transform: 'translateX(435%)', scale: 1.75, ease: Expo.easeInOut, duration: .5 }, '-=.61')
